...
import type { Slide, AnglePreset } from '../types'
...
// Shadow settings for the device - used for the exportable shadow element
function getShadowStyle(angle: AnglePreset): React.CSSProperties {
  let offsetX = 0
  let offsetY = 40
  let blur = 80
  let opacity = 0.3
    ...
    >
      ...
      <div
        ...
        style={{
          ...
          lineHeight: 1.2,
          textShadow: slide.text.color === 'white' ? '0 2px 4px rgba(0,0,0,0.4)' : 'none',
          zIndex: 10,
        }}
      >
